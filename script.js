...
function fun() {
   c++
   if (c == 0 ) {
      nom.innerText = 'Decisão de modelo'
      desc.innerText = 'Você me fala sobre seu negócio e seu estilo, e eu te indico os modelos que mais combinam com você. Depois da sua decisão de modelo, eu adapto tudo com suas cores, informações e identidade. Caso eu não tenha um modelo específico para seu negócio, vou criar um modelo do zero para você!'
      ddd.innerText = 'Continuar'
   }
   if (c == 1 ) {
      nom.innerText = 'Envio das informações'
      ...
      if (c == 2 ) {
      nom.innerText = 'Criação da página'
